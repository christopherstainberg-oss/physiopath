...
const INJURY_FOCUS = [
  ...
  {re:/rotator cuff|cuff tear|cuff tendin|supraspinatus|infraspinatus|subscapularis|calcific tendin/,   // broadened: bare cuff-muscle names catch "-itis"/"-tear"/"-strain"; a repair routes to its own focus below
  ...
  /* ---- post-surgical / arthroplasty recovery ----
     The same structure heals on a PROTECT-first clock, so these carry distinct early priorities from
     the conservative versions above/below. Each out-matches the generic bucket via a longer name hit. */
  {re:/rotator cuff (repair|reconstruction)|cuff repair|supraspinatus repair|subscapularis repair|infraspinatus repair/,
   ...
   add:[{p:1,n:"Pendulum swings & passive supported elevation",d:"3×10",c:"Let the other arm or gravity do the work — the repaired cuff stays relaxed"},
  ...
  {re:/(total |unicompartmental |partial )?knee (replacement|arthroplasty)|\btkr\b|\bukr\b/,
   ...
   add:[{p:1,n:"Quad sets & straight-leg raise",d:"hourly ×10, 5s holds",c:"Fully straighten and lift without the knee bending — this beats an extensor lag"},
  ...
  {re:/(total |partial )?hip (replacement|arthroplasty)|\bthr\b|hemiarthroplasty of the hip/,
   ...
   add:[{p:1,n:"Glute sets, ankle pumps & static quads",d:"hourly ×10",c:"Squeeze the buttock; the pumps guard against clots"},
  ...
  {re:/achilles( tendon)? (rupture|repair)|ruptured achilles/,
   ...
   add:[{p:1,n:"Active plantarflexion in the boot (no stretch)",d:"hourly ×10",c:"Point the toes DOWN only — never pull the foot up past neutral"},
  ...
  {re:/lumbar fusion|spinal fusion|post-?fusion|\bplif\b|\btlif\b|\balif\b|lumbar arthrodesis/,
   ...
   add:[{p:1,n:"Frequent short walks",d:"5–10 min, several times a day",c:"The best early medicine for a fusion — little and often",tags:["weight_bearing"]},
...
const PROTOCOL_APPROACH = {
  ...
  hip_oa:"strengthening the hips and glutes and using joint-friendly walking or cycling — not sport cutting",
